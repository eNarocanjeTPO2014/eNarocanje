...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Customer.service_provider'
        db.add_column(u'customers_customer', 'service_provider',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['accountext.ServiceProvider'], null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Customer.service_provider'
        db.delete_column(u'customers_customer', 'service_provider_id')
    ...
    models = {
        ...
        u'accountext.serviceprovider': {
            ...
            'subscription_end_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 5, 4, 0, 0)'}),
        ...
        u'customers.customer': {
            ...
            'last_reservation': ('django.db.models.fields.DateTimeField', [], {'default': 'None', 'auto_now_add': 'True', 'blank': 'True'}),
