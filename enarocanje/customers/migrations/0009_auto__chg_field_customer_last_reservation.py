...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'customers_customer', 'last_reservation', self.gf('django.db.models.fields.DateTimeField')(null=True))

    def backwards(self, orm):

        # Changing field 'Customer.last_reservation'
        db.alter_column(u'customers_customer', 'last_reservation', self.gf('django.db.models.fields.DateTimeField')(default=None))
    ...
    models = {
        ...
        u'customers.customer': {
            ...
            'last_reservation': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 4, 5, 0, 0)', 'null': 'True'}),
