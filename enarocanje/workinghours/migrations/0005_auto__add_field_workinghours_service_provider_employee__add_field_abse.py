...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Absence.service_provider_employee'
        db.add_column(u'workinghours_absence', 'service_provider_employee',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['ServiceProviderEmployee.ServiceProviderEmployee'], null=True),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'Absence.service_provider_employee'
        db.delete_column(u'workinghours_absence', 'service_provider_employee_id')
    ...
    models = {
        ...
        u'accountext.serviceprovider': {
            ...
            'subscription_end_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 7, 1, 0, 0)'}),
        ...
        u'workinghours.workinghours': {
            ...
            'service_provider_employee': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'working_hours'", 'null': 'True', 'to': u"orm['ServiceProviderEmployee.ServiceProviderEmployee']"}),
