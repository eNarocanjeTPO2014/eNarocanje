...
def getReservations(provider, start, end, employee_id, selected_service, selected_data):
    ...
    for reservation in reservations:
        ...
        #Prikazi vse
        if selected_data == 0:
            if reservation.service_provider_employee and reservation.customer:
                eventTitle= 'Customer:' + reservation.customer.name + reservation.customer.last_name +\
            ...
            elif reservation.customer:
                eventTitle= 'Customer:' + reservation.customer.name + reservation.customer.last_name +\
                            " | " + 'Employee:' + 'None selected' +\
                            " | " + 'Service:' + reservation.service_name
            else:
                eventTitle= 'Customer:' +'None' +\
                            " | " + 'Employee:' + 'None selected' +\
                            " | " + 'Service:' + reservation.service_name
        #Prikazi stranke
        elif selected_data == 1:
            if reservation.customer:
                eventTitle= reservation.customer.name + reservation.customer.last_name
            else:
                eventTitle='None'
        #Prikazi zaposlene
        elif selected_data == 2:
            if reservation.service_provider_employee:
                eventTitle= reservation.service_provider_employee.first_name + reservation.service_provider_employee.last_name
            else:
                eventTitle= 'None selected'
        #Prikazi storitve
