...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Reservation.customer'
        db.add_column(u'reservations_reservation', 'customer',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['customers.Customer'], null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Reservation.customer'
        db.delete_column(u'reservations_reservation', 'customer_id')
    ...
    models = {
        ...
        u'accountext.serviceprovider': {
            ...
            'subscription_end_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 5, 2, 0, 0)'}),
