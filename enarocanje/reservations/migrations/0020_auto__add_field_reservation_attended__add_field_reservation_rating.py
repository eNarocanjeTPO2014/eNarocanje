...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Reservation.attended'
        db.add_column(u'reservations_reservation', 'attended',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)

        # Adding field 'Reservation.rating'
        db.add_column(u'reservations_reservation', 'rating',
                      self.gf('django.db.models.fields.IntegerField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Reservation.attended'
        db.delete_column(u'reservations_reservation', 'attended')

        # Deleting field 'Reservation.rating'
        db.delete_column(u'reservations_reservation', 'rating')
    ...
    models = {
        ...
        u'customers.customer': {
            ...
            'last_reservation': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 4, 29, 0, 0)', 'null': 'True'}),
        ...
        u'reservations.reservation': {
            ...
            'attended': ('django.db.models.fields.BooleanField', [], {'default': 'True'}),
