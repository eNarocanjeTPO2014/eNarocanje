...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Reservation.service_notifications'
        db.add_column(u'reservations_reservation', 'service_notifications',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Reservation.service_notifications'
        db.delete_column(u'reservations_reservation', 'service_notifications')
    ...
    models = {
        ...
        u'customers.customer': {
            ...
            'last_reservation': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 5, 7, 0, 0)', 'null': 'True'}),
            'name': ('django.db.models.fields.CharField', [], {'max_length': '60', 'null': 'True'}),
            'number_of_reservations': ('django.db.models.fields.IntegerField', [], {'default': '0', 'null': 'True'}),
