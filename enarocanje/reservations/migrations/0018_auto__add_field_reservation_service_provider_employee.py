...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Reservation.service_provider_employee'
        db.add_column(u'reservations_reservation', 'service_provider_employee',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['ServiceProviderEmployee.ServiceProviderEmployee'], null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Reservation.service_provider_employee'
        db.delete_column(u'reservations_reservation', 'service_provider_employee_id')
    ...
    models = {
        ...
        u'accountext.serviceprovider': {
            ...
            'subscription_end_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 5, 8, 0, 0)'}),
        ...
        u'customers.customer': {
            ...
            'last_reservation': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 4, 8, 0, 0)', 'null': 'True'}),
