...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ServiceProvider.send_email_reminder'
        db.add_column(u'accountext_serviceprovider', 'send_email_reminder',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'ServiceProvider.send_sms_reminder'
        db.add_column(u'accountext_serviceprovider', 'send_sms_reminder',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'User.send_reminders'
        db.add_column(u'accountext_user', 'send_reminders',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ServiceProvider.send_email_reminder'
        db.delete_column(u'accountext_serviceprovider', 'send_email_reminder')

        # Deleting field 'ServiceProvider.send_sms_reminder'
        db.delete_column(u'accountext_serviceprovider', 'send_sms_reminder')

        # Deleting field 'User.send_reminders'
        db.delete_column(u'accountext_user', 'send_reminders')
    ...
    models = {
        ...
        u'accountext.serviceprovider': {
            ...
            'subscription_end_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 6, 25, 0, 0)'}),
        ...
        u'accountext.user': {
            ...
            'service_notifications': ('django.db.models.fields.BooleanField', [], {'default': 'True'}),
